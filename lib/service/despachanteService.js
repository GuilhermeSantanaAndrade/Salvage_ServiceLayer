...
var despachante = {
  Despachante: function Despachante() {
    var Despachante = {
      id: -1,
      guid: '',
      tipo_entidade: '',
  ...
  setDespachante: function setDespachante(data) {
    var aux = this.Despachante();
  ...
  setDefaults: function setDefaults(dados) {
    if (dados.tipo_entidade === undefined || dados.tipo_entidade.toString() === '') dados.tipo_entidade = 'Despachante';
  ...
  incluir: function incluir(dados) {
    try {
      if (!_funcoes2.default.isEquivalentObjects(dados, this.Despachante())) {
      ...
      return _http2.default.post('/api/despachantes/', { "tipoEmpresa": dados.tipo_entidade,
  ...
  alterar: function alterar(dados) {
    try {
      ...
      return _http2.default.put('/api/despachantes/' + dados.guid, { "id": dados.id,
        "guid": dados.guid,
  ...
  deletar: function deletar(guid) {
    try {
      return _http2.default.delete('/api/despachantes/' + guid).then(function (response) {
        if (response.status != 200) {
          throw Error(response.data.message);
        }
  ...
  listar: function listar(dados) {
    ...
    try {
      ...
      return _http2.default.get(url, api_params).then(function (response) {
        ...
        var listDespachantes = resultArray.map(function (values) {
          var des = _this.Despachante();
          ...
          des.ie = values.ie;
          if (values.dataCriacao !== undefined && values.dataCriacao !== null && values.dataCriacao !== '') des.dataCriacao = values.dataCriacao;

          if (values.dataAtualizacao !== undefined && values.dataAtualizacao !== null && values.dataAtualizacao !== '') des.dataAtualizacao = values.dataAtualizacao;
